				...
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
                            ...
                            <form method="POST" name="submi" class="my-login-validation" novalidate="" action="">
								
								<div class="form-group m-0">
									<button type="submit" name="submi" class="btn btn-primary btn-block">
										Envoyer un code vers mon mail
									</button>
								</div>
							...
							<br>
							<?php include_once '../connect/verif_connect.php';?>
						</div>
					</div>				
					<div class="footer">
